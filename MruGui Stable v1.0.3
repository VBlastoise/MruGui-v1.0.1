if IY_LOADED and not _G.IY_DEBUG == true then
	-- error("MruGui is already running!",0)
	return
end
...
if not game:IsLoaded() then
	...
	notLoaded.Text = 'MruGui is waiting for the game to load'
	game.Loaded:Wait()
	notLoaded:Destroy()
end
...
Title.TextSize = 18
Title.Text = "MruGui v" .. currentVersion
...
Logo.Image = "rbxassetid://12175437249"
...
Credits.Text = "FaZeDeJwIdEk#7915"
...
reference = (function()
	local main = create({
		...
		{114,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={112},Position=UDim2.new(0,8,0,30),Size=UDim2.new(1,-8,0,32),Text="go to the MruGuis discord server",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
	...
	inviteButton.MouseButton1Click:Connect(function()
		...
		inviteButton.Text = "Copy Discord Invite Link (https://discord.gg/bMd3BDkACS)"
	end)
	dragGUI(main)
	main.Parent = PARENT
...
SaveChatlogs.MouseButton1Down:Connect(function()
	if writefileExploit() then
		if #scroll_2:GetChildren() > 0 then
			...
			local writelogs = '-- MruGuis Chat logs for "'..placeName..'"\n'
			for _, child in pairs(scroll_2:GetChildren()) do
				writelogs = writelogs..'\n'..child.Text
			end
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'discord / support / help', DESC = 'MruGuis server for support.'}
...
addcmd('discord', {'support', 'help'}, function(args, speaker)
	if toClipboard then
		toClipboard('https://discord.gg/bMd3BDkACS')
		notify('Discord Invite', 'Copied to clipboard!\n')
	else
		notify('Discord Invite', 'https://discord.gg/bMd3BDkACS')
	end
	if httprequest then
		httprequest({
...
addcmd('nohead',{'rhead','headless'},function(args, speaker)
	if sethidden then
		-- Full credit to FaZeDeJvIdEk#7915 @Discord
...
task.spawn(function()
	local success, latestVersionInfo = pcall(function() 
		local versionJson = game:HttpGet('https://raw.githubusercontent.com/VBlastoise/version/main/version')
